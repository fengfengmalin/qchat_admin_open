...
//                this.productId.equalsIgnoreCase(value.productId) &&
    ...
    public boolean isValid() {
        ...
        try {
            if (System.currentTimeMillis() - lastAckTime.getTime() < SESSION_TIME_OUT)
                return true;
            return false;
    ...
    public static QtSessionItem parseFromRedis(String key) {
        Map<String, Object> cacheValue = CacheHelper.get(CacheHelper.CacheType.SeatCache, key, Map.class);
        JID from = null;
