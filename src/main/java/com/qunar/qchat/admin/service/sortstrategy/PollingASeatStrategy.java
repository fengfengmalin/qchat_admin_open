...
@Component("pollingSeatStrategy")
public class PollingASeatStrategy extends ASeatSortStrategy {
//    private static final Logger LOGGER = LoggerFactory.getLogger(PollingASeatStrategy.class);
