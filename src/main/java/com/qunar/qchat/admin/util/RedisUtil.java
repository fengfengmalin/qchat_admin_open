...
public class RedisUtil {
    ...
    public static <T> void set(int table, String key, T value) {
        ((JedisConnectionFactory) redisTemplate.getConnectionFactory()).setDatabase(table);
        try {
    ...
    public static Set<String> keys(int table){
        ((JedisConnectionFactory) redisTemplate.getConnectionFactory()).setDatabase(table);
        try {
    ...
    public static Set<String> hkeys(int table, String key) {
    ...
    public static <T> void expire(int table,String key,long timeout, TimeUnit timeUnit) {
        try {
            ((JedisConnectionFactory) redisTemplate.getConnectionFactory()).setDatabase(table);
            redisTemplate.expire(key,timeout,timeUnit);
        } catch (Exception e) {
            logger.info("向redis中插入hash数据失败，key:{},", key, e);
        }
    }
     ...
     */
    public void setRedisTemplate(StringRedisTemplate redisTemp) {
