...
import com.qunar.qchat.admin.annotation.AspectOrder;
...
public class RoutingDataSourceAdvisor {
    ...
    @Pointcut("execution(@com.qunar.qchat.admin.annotation.routingdatasource.RoutingDataSource * com.qunar.qchat.admin..*Service+.*(..))")
